...
namespace GameStates {
	public class StrikeState : AbstractGameObjectState {
		...
		public StrikeState(MonoBehaviour parent) : base(parent) { 
			...
			var relativeDistance = (Vector3.Distance(club1.transform.position, cueBall.transform.position) - PoolGameController.MIN_DISTANCE) / (PoolGameController.MAX_DISTANCE - PoolGameController.MIN_DISTANCE);
